...
from NewsAggregationSystem.server.routes import authentication_routes, article_routes, external_server_routes, \
    category_routes, user_routes, admin_routes, notification_setting_routes
...
app.include_router(notification_setting_routes.router)
